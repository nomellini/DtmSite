...
class EmpresaLgpdResponsavel extends React.Component {
    componentDidMount() {
...
const connectedEmpresaLgpdResponsavel = connect(mapStateToProps)(EmpresaLgpdResponsavel);
export { connectedEmpresaLgpdResponsavel as EmpresaLgpdResponsavel };